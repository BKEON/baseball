...
export const RESULT_INFO: Record<ResultType, ResultInfo> = {
  열정응원러: {
    ...
    seatZone: "cheering",
    seatDetail: "1루측 내야 카스존 (응원단석)",
    seatZoneLabel: "카스존 (응원단석)",
  },
  잔디감성형: {
    type: "잔디감성형",
    seat: "밤켈존 (잔디석)",
    ...
    seatZone: "lawn",
    seatDetail: "좌측 외야 밤켈존 (잔디석) 500구역",
    seatZoneLabel: "밤켈존 (잔디석)",
  },
  가족피크닉형: {
    type: "가족피크닉형",
    seat: "중앙 탁자석 / 내야 탁자석(4층)",
    emoji: "🍗",
    description:
      "크림새우, 떡볶이, 치킨 등 야구장 시그니처 메뉴 접수가 최우선! 음식을 편하게 두고 먹을 수 있는 탁자석이 최고의 명당인 야구장 맛집 탐방가형.",
    color: "#ea7c1a",
    bgGradient: "from-amber-900 via-orange-900 to-hw-dark",
    traits: ["먹방유튜버", "맛집 탐방", "탁자석 고수", "야구장 미식가"],
    seatZone: "table",
    seatDetail: "중앙 탁자석 (100A~100C) / 내야 탁자석 4층",
    seatZoneLabel: "중앙·내야 탁자석",
  },
  데이터분석형: {
    type: "데이터분석형",
    seat: "외야지정석",
    emoji: "🚪",
    description:
      "답답하거나 지루한 건 못 참는 효율 중시 타입! 분위기 최고일 때 즐기고, 경기가 처지면 미련 없이 일어나는 낄끼빠빠형. 언제든 이동하기 쉬운 외야지정석이 찰떡!",
    color: "#7c3aed",
    bgGradient: "from-purple-900 via-violet-900 to-hw-dark",
    traits: ["효율 최우선", "낄끼빠빠", "탈출 전문가", "자유로운 영혼"],
    seatZone: "aisle",
    seatDetail: "외야지정석 501~508구역",
    seatZoneLabel: "외야지정석",
  },
  직관몰입형: {
    type: "직관몰입형",
